...
-- Topik        : List
-- Deskripsi    : Cari elemen tengah/ median
...
-- REALISASI
elemenTengah l = if mod (length l) 2 == 0 then head (drop (div (length l) 2) l)
                 else head (drop (div (length l) 2) l)
                 
                 --aplikasi elemenTengah [1,2,3]